...
计算参照值时，地图采用圆域面积均匀的位置分布，源数取 $10$--$16$ 的等概率分布或演练经验频率。
若未与演练地图配对，比较也仅限于总体量级，不据此判断逐图最优性。
% 历史附件待核对：全知者100000张地图，经验源数加权135.6455 s/源（纯移动）；
% Bayes演练50轮669/669、214.8761 s/源。未经版本与原始日志核对，不填入正文结果。
\FloatBarrier
